...
<span style="color: gray; font-size:0.9em; line-height:1em;"> **Abstract** : Using micro-data of the universe of bank-SME relationships in France, we show that banks specialize locally (at the branch level) by industry, and that this specialization shapes the equilibrium amount of borrowing by small firms. For identification, we exploit the reallocation of local clients from closing branches to nearby branches of the same bank, which induced quasi-random variation in the match between a firm's industry and industry of specialization of the branch. We show that branch reallocation leads, on average, to a substantial and permanent decline in small firm borrowing. This decline is fully explained by firms whose accounts were reallocated from branches less specialized in their industry than the original one. Consistently with previous studies, we observe a significant drop in the supply of credit to small borrowers around the date of the closing. However, the effect of the closing almost doubles when the firm's account is transferred from a branch which was specialized in lending to its industry to a new, non-specialized, branch of the same bank.  </span>
...
<span style="color: gray;">**R&R at Journal of International Economics** </span>
...
<span style="color: gray;"> **Applied Economics Letters (2018)**  </span>  
